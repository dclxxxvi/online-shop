...
export const SortableBlock: React.FC<SortableBlockProps> = ({ block, isSelected, onSelect }) => {
	...
	const { marginTop, marginRight, marginBottom, marginLeft, ...contentStyles } =
		desktopStyles as React.CSSProperties;
	...
	return (
		<div className="max-w-xs mx-auto bg-white border rounded-lg overflow-hidden shadow-sm">
			...
			<div className="p-4">
				...
				{showPrice && <p className="text-lg font-bold text-emerald-600 mb-2">{price}</p>}
				{showRating && (
