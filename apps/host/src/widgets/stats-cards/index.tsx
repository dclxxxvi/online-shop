...
import { Card, CardContent } from '@shop-builder/shared';
        ...
        <div>
          ...
          {trend && (
            ...
            >
              ...
              <span className="text-gray-500 font-normal"> vs прошлый месяц</span>
            </p>
          )}
        </div>
...
export const StatsCards: React.FC = () => {
  ...
  const draftStores = stores.filter((s) => !s.isPublished).length;
